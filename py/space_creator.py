...
class Creator(object):
    ...
    def __init__(self, config: ConfigSettings, announcer: partial):
        self._cfg = config
        self.documents = list()
    ...
    def create_space(self, clean_documents):
        ...
        lsa_model = LsiModel(log_ent_corpus, id2word=dictionary, num_topics=self._cfg.space_settings.dimensions, distributed=False)
